...
//            .collect(Collectors.toList());
    ...
    public static List<AlbumGateway> filteredAlbumGatewayByUserId(List<AlbumGateway> albums, Integer userId){
        return albums.stream()
                .filter(albumResponse -> albumResponse.getUserId().equals(userId))
                .collect(Collectors.toList());
    }
...
//            .collect(Collectors.toList());
    ...
    public static List<PostGateway> filteredPostGatewayByUserId (List<PostGateway> posts, Integer userId){
        return posts.stream()
