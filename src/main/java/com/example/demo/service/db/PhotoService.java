...
public class PhotoService {
    ...
    public void create(List<PhotoDomain> photos) {
    ...
    public void seed(List<PhotoGateway> photoGateways, String albumId)
    {
        ArrayList<PhotoDomain> photosToSave = new ArrayList<PhotoDomain>();
        photoGateways.forEach(photoGateway ->
        {
            PhotoDomain photo = ConverterPhotoDB.convertPhotoGatewayToDomain(photoGateway);
            photo.setAlbumId(new ObjectId(albumId));
